# Feature: alphagpt-refactor, Property 6: 回测 80/20 分割不变量
# Feature: alphagpt-refactor, Property 7: 高换手率惩罚单调性
"""
Property-based tests for model_core.backtest (ContinuousBacktest).
...
def test_property6_backtest_80_20_split(T: int):
    """
    For any T, ContinuousBacktest.evaluate() must use exactly floor(T*0.8) steps
