...
- len(OPS_CONFIG) == 62（registry 派生：44 初始 + 3 CS + 8 Task3.3 + 7 Task3.4）
...
class TestOpsConfigLength:
    def test_ops_config_length_equals_62(self):
        """OPS_CONFIG 共 62 个算子（OPERATOR_REGISTRY 派生导出视图，与注册表一致）"""
