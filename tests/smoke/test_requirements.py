...
def test_metatrader5_removed():
    """MT5 已从系统移除：requirements.txt 不得再出现 MetaTrader5。"""
    assert not _pkg_present("metatrader5"), (
        "MetaTrader5 must not be listed — MT5 was removed from the system "
        "(unusable on macOS; old code archived in git history)."
    )
